package com.abindustrybreeze.features.dashboard.presentation
...
import com.abindustrybreeze.*
import com.abindustrybreeze.R
import com.abindustrybreeze.app.*
import com.abindustrybreeze.app.NewFileUtils.browseDocuments
import com.abindustrybreeze.app.NewFileUtils.browsePDFDocuments
import com.abindustrybreeze.app.NewFileUtils.getExtension
import com.abindustrybreeze.app.domain.*
import com.abindustrybreeze.app.types.DashboardType
import com.abindustrybreeze.app.types.FragType
import com.abindustrybreeze.app.types.TopBarConfig
import com.abindustrybreeze.app.uiaction.DisplayAlert
import com.abindustrybreeze.app.utils.*
import com.abindustrybreeze.app.utils.AppUtils.Companion.isProfile
import com.abindustrybreeze.base.BaseResponse
import com.abindustrybreeze.base.presentation.BaseActivity
import com.abindustrybreeze.base.presentation.BaseFragment
import com.abindustrybreeze.features.NewQuotation.*
import com.abindustrybreeze.features.NewQuotation.api.GetQuotRegProvider
import com.abindustrybreeze.features.NewQuotation.model.ViewDetailsQuotResponse
import com.abindustrybreeze.features.SearchLocation.SearchLocationFragment
import com.abindustrybreeze.features.SearchLocation.locationInfoModel
import com.abindustrybreeze.features.TA.ViewAllTAListFragment
import com.abindustrybreeze.features.achievement.AchievementFragment
import com.abindustrybreeze.features.activities.presentation.*
import com.abindustrybreeze.features.addAttendence.*
import com.abindustrybreeze.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.abindustrybreeze.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.abindustrybreeze.features.addAttendence.model.GetReportToFCMResponse
import com.abindustrybreeze.features.addAttendence.model.GetReportToResponse
import com.abindustrybreeze.features.addAttendence.model.Leave_list_Response
import com.abindustrybreeze.features.addorder.presentation.AddOrderFragment
...
import com.abindustrybreeze.features.addshop.presentation.AddShopFragment
import com.abindustrybreeze.features.addshop.presentation.OTPVerificationDialog
import com.abindustrybreeze.features.addshop.presentation.ScanImageFragment
import com.abindustrybreeze.features.addshop.presentation.ShowCardDetailsDialog
import com.abindustrybreeze.features.alarm.model.AlarmData
import com.abindustrybreeze.features.alarm.presetation.AttendanceReportFragment
import com.abindustrybreeze.features.alarm.presetation.PerformanceReportFragment
import com.abindustrybreeze.features.alarm.presetation.VisitReportDetailsFragment
import com.abindustrybreeze.features.alarm.presetation.VisitReportFragment
import com.abindustrybreeze.features.attendance.AttendanceFragment
import com.abindustrybreeze.features.attendance.api.AttendanceRepositoryProvider
import com.abindustrybreeze.features.attendance.model.AttendanceRequest
import com.abindustrybreeze.features.attendance.model.AttendanceResponse
import com.abindustrybreeze.features.averageshop.presentation.AverageShopFragment
import com.abindustrybreeze.features.avgorder.presentation.AverageOrderFragment
import com.abindustrybreeze.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.abindustrybreeze.features.beatCustom.TeamBeatListFragment
import com.abindustrybreeze.features.billing.presentation.AddBillingFragment
import com.abindustrybreeze.features.billing.presentation.BillingDetailsFragment
import com.abindustrybreeze.features.billing.presentation.BillingListFragment
import com.abindustrybreeze.features.changepassword.presentation.ChangePasswordDialog
import com.abindustrybreeze.features.chat.model.ChatListDataModel
import com.abindustrybreeze.features.chat.model.ChatUserDataModel
import com.abindustrybreeze.features.chat.model.GroupUserDataModel
import com.abindustrybreeze.features.chat.presentation.*
import com.abindustrybreeze.features.chatbot.presentation.ChatBotFragment
import com.abindustrybreeze.features.chatbot.presentation.ChatBotShopListFragment
import com.abindustrybreeze.features.chatbot.presentation.ReportsFragment
import com.abindustrybreeze.features.chatbot.presentation.SelectLanguageDialog
import com.abindustrybreeze.features.commondialog.presentation.CommonDialog
import com.abindustrybreeze.features.commondialog.presentation.CommonDialogClickListener
import com.abindustrybreeze.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.abindustrybreeze.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.abindustrybreeze.features.commondialogsinglebtn.OnDialogClickListener
import com.abindustrybreeze.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.abindustrybreeze.features.contacts.ActivityDtlsFrag
import com.abindustrybreeze.features.contacts.AddOpptFrag
import com.abindustrybreeze.features.contacts.ContactDtls
import com.abindustrybreeze.features.contacts.ContactGr
import com.abindustrybreeze.features.contacts.ContactsAddFrag
import com.abindustrybreeze.features.contacts.ContactsFrag
import com.abindustrybreeze.features.contacts.SchedulerViewFrag
import com.abindustrybreeze.features.contacts.SchedulerAddFormFrag
import com.abindustrybreeze.features.contacts.TemplateAddFrag
import com.abindustrybreeze.features.contacts.TemplateViewFrag
import com.abindustrybreeze.features.contacts.ViewCrmOpptFrag
import com.abindustrybreeze.features.dailyPlan.prsentation.AllShopListFragment
import com.abindustrybreeze.features.dailyPlan.prsentation.DailyPlanListFragment
import com.abindustrybreeze.features.dailyPlan.prsentation.PlanDetailsFragment
import com.abindustrybreeze.features.damageProduct.ShopDamageProductListFrag
import com.abindustrybreeze.features.damageProduct.ShopDamageProductSubmitFrag
import com.abindustrybreeze.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.abindustrybreeze.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.abindustrybreeze.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.abindustrybreeze.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.abindustrybreeze.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.abindustrybreeze.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.abindustrybreeze.features.dashboard.presentation.model.ContentListResponseModel
import com.abindustrybreeze.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.abindustrybreeze.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.abindustrybreeze.features.device_info.presentation.DeviceInfoListFragment
import com.abindustrybreeze.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.abindustrybreeze.features.document.DocumentRepoFeatureNewFragment
import com.abindustrybreeze.features.document.presentation.DocumentListFragment
import com.abindustrybreeze.features.document.presentation.DocumentTypeListFragment
import com.abindustrybreeze.features.document.presentation.OpenFileWebViewFragment
import com.abindustrybreeze.features.dymanicSection.presentation.AddDynamicFragment
import com.abindustrybreeze.features.dymanicSection.presentation.AllDynamicListFragment
import com.abindustrybreeze.features.dymanicSection.presentation.DynamicListFragment
import com.abindustrybreeze.features.dymanicSection.presentation.EditDynamicFragment
import com.abindustrybreeze.features.gpsDisabilityScreen.GpsDisableFragment
import com.abindustrybreeze.features.home.presentation.HomeFragment
import com.abindustrybreeze.features.homelocation.presentation.HomeLocationFragment
import com.abindustrybreeze.features.homelocation.presentation.HomeLocationMapFragment
import com.abindustrybreeze.features.know_your_state.KnowYourStateFragment
import com.abindustrybreeze.features.lead.LeadFrag
import com.abindustrybreeze.features.lead.ViewLeadFrag
import com.abindustrybreeze.features.leaderboard.LeaderBoardFrag
import com.abindustrybreeze.features.leaveapplynew.LeaveHome
import com.abindustrybreeze.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.abindustrybreeze.features.localshops.LocalShopListFragment
import com.abindustrybreeze.features.localshops.LocalShopListMapFragment
import com.abindustrybreeze.features.localshops.NearByShopsMapFragment
import com.abindustrybreeze.features.location.*
import com.abindustrybreeze.features.location.api.LocationRepoProvider
import com.abindustrybreeze.features.location.model.*
import com.abindustrybreeze.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.abindustrybreeze.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.abindustrybreeze.features.login.ShopFeedbackEntity
import com.abindustrybreeze.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.abindustrybreeze.features.login.presentation.LoginActivity
import com.abindustrybreeze.features.logout.presentation.api.LogoutRepositoryProvider
import com.abindustrybreeze.features.logoutsync.presentation.LogoutSyncFragment
import com.abindustrybreeze.features.marketAssist.MarketAssistTabFrag
import com.abindustrybreeze.features.marketAssist.ShopDtlsMarketAssistFrag
import com.abindustrybreeze.features.marketAssist.ShopListMarketAssistFrag
import com.abindustrybreeze.features.marketing.presentation.MarketingPagerFragment
import com.abindustrybreeze.features.meetinglist.prsentation.MeetingListFragment
import com.abindustrybreeze.features.member.MapViewForTeamFrag
import com.abindustrybreeze.features.member.model.TeamLocDataModel
import com.abindustrybreeze.features.member.model.TeamShopListDataModel
import com.abindustrybreeze.features.member.presentation.*
import com.abindustrybreeze.features.menuBeat.MenuBeatFrag
import com.abindustrybreeze.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.abindustrybreeze.features.micro_learning.presentation.MicroLearningListFragment
import com.abindustrybreeze.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.abindustrybreeze.features.myallowancerequest.MyallowanceRequestFragment
import com.abindustrybreeze.features.myjobs.model.CustomerDataModel
import com.abindustrybreeze.features.myjobs.presentation.*
import com.abindustrybreeze.features.mylearning.MyLearningFragment
import com.abindustrybreeze.features.myorder.presentation.MyOrderListFragment
import com.abindustrybreeze.features.myprofile.presentation.MyProfileFragment
import com.abindustrybreeze.features.nearbyshops.api.ShopListRepositoryProvider
import com.abindustrybreeze.features.nearbyshops.model.ShopData
import com.abindustrybreeze.features.nearbyshops.model.ShopListResponse
import com.abindustrybreeze.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.abindustrybreeze.features.nearbyshops.presentation.BeatListFragment
import com.abindustrybreeze.features.nearbyshops.presentation.NearByShopsListFragment
import com.abindustrybreeze.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.abindustrybreeze.features.nearbyshops.presentation.ShopCallHisFrag
import com.abindustrybreeze.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.abindustrybreeze.features.newcollection.CollectionDetailsStatusFragment
import com.abindustrybreeze.features.newcollection.CollectionShopListFragment
import com.abindustrybreeze.features.newcollection.NewCollectionListFragment
import com.abindustrybreeze.features.newcollectionreport.*
import com.abindustrybreeze.features.notification.NotificationFragment
import com.abindustrybreeze.features.orderITC.CartListFrag
import com.abindustrybreeze.features.orderITC.OrderListFrag
import com.abindustrybreeze.features.orderITC.ProductListFrag
import com.abindustrybreeze.features.orderITC.ViewNewOrdHisAllFrag
import com.abindustrybreeze.features.orderITC.ViewNewOrdHistoryFrag
import com.abindustrybreeze.features.orderITC.ViewOrdDtls
import com.abindustrybreeze.features.orderList.NewDateWiseOrderListFragment
import com.abindustrybreeze.features.orderList.NewOrderListFragment
import com.abindustrybreeze.features.orderList.OrderListFragment
import com.abindustrybreeze.features.orderdetail.presentation.OrderDetailFragment
import com.abindustrybreeze.features.orderhistory.ActivityMapFragment
import com.abindustrybreeze.features.orderhistory.OrderhistoryFragment
import com.abindustrybreeze.features.orderhistory.TimeLineFragment
import com.abindustrybreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.abindustrybreeze.features.orderhistory.model.LocationData
import com.abindustrybreeze.features.pendinglocationinout.PendingOutLocationFrag
import com.abindustrybreeze.features.performance.GpsStatusFragment
import com.abindustrybreeze.features.performance.PerformanceFragment
import com.abindustrybreeze.features.performance.api.UpdateGpsStatusRepoProvider
import com.abindustrybreeze.features.performance.model.UpdateGpsInputParamsModel
import com.abindustrybreeze.features.performanceAPP.OwnPerformanceFragment
import com.abindustrybreeze.features.performanceAPP.PerformanceAppFragment
import com.abindustrybreeze.features.performanceAPP.allPerformanceFrag
import com.abindustrybreeze.features.permissionList.ViewPermissionFragment
import com.abindustrybreeze.features.photoReg.*
import com.abindustrybreeze.features.privacypolicy.PrivacypolicyWebviewFrag
import com.abindustrybreeze.features.quotation.presentation.*
import com.abindustrybreeze.features.reimbursement.presentation.*
import com.abindustrybreeze.features.report.presentation.*
import com.abindustrybreeze.features.returnsOrder.*
import com.abindustrybreeze.features.settings.presentation.SettingsFragment
import com.abindustrybreeze.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.abindustrybreeze.features.shopdetail.presentation.*
import com.abindustrybreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.abindustrybreeze.features.stock.StockDetailsFragment
import com.abindustrybreeze.features.stock.StockListFragment
import com.abindustrybreeze.features.stockAddCurrentStock.AddShopStockFragment
import com.abindustrybreeze.features.stockAddCurrentStock.UpdateShopStockFragment
import com.abindustrybreeze.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.abindustrybreeze.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.abindustrybreeze.features.stockCompetetorStock.AddCompetetorStockFragment
import com.abindustrybreeze.features.stockCompetetorStock.CompetetorStockFragment
import com.abindustrybreeze.features.stockCompetetorStock.ViewComStockProductDetails
import com.abindustrybreeze.features.survey.SurveyFrag
import com.abindustrybreeze.features.survey.SurveyViewDtlsFrag
import com.abindustrybreeze.features.survey.SurveyViewFrag
import com.abindustrybreeze.features.task.presentation.AddTaskFragment
import com.abindustrybreeze.features.task.presentation.CalenderTaskFragment
import com.abindustrybreeze.features.task.presentation.EditTaskFragment
import com.abindustrybreeze.features.task.presentation.TaskListFragment
import com.abindustrybreeze.features.taskManagement.TaskManagementFrag
import com.abindustrybreeze.features.taskManagement.ViewTaskManagementFrag
import com.abindustrybreeze.features.timesheet.presentation.AddTimeSheetFragment
import com.abindustrybreeze.features.timesheet.presentation.EditTimeSheetFragment
import com.abindustrybreeze.features.timesheet.presentation.TimeSheetListFragment
import com.abindustrybreeze.features.viewAllOrder.CartFragment
import com.abindustrybreeze.features.viewAllOrder.OrderTypeListFragment
import com.abindustrybreeze.features.viewAllOrder.ViewAllOrderListFragment
import com.abindustrybreeze.features.viewAllOrder.ViewCartFragment
import com.abindustrybreeze.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.abindustrybreeze.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.abindustrybreeze.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.abindustrybreeze.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.abindustrybreeze.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.abindustrybreeze.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.abindustrybreeze.features.viewPPDDStock.ViewOutstandingFragment
import com.abindustrybreeze.features.viewPPDDStock.ViewPPDDListFragment
import com.abindustrybreeze.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.abindustrybreeze.features.viewPPDDStock.ViewStockFragment
import com.abindustrybreeze.features.weather.presentation.WeatherFragment
import com.abindustrybreeze.mappackage.MapActivity
import com.abindustrybreeze.mappackage.MapActivityWithoutPath
import com.abindustrybreeze.mappackage.SendBrod
import com.abindustrybreeze.widgets.AppCustomEditText
import com.abindustrybreeze.widgets.AppCustomTextView
...
//            }
            ...
            R.id.tv_clear_attendance -> {
                if (AppUtils.isOnline(mContext)) {
                    ...
                    var newOrdListForITCToday = AppDatabase.getDBInstance()!!.newOrderDataDao().getTodayOrder(AppUtils.getCurrentDateForShopActi())
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xabindustrybreezelogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.abindustrybreeze/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log.bak.1").path);
...
//                }, 2500)
        ...
        /*17-12-2021*/
            ...
            FragType.MyLearningFragment -> {
                ...
                setTopBarTitle(getString(R.string.my_learning))
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
