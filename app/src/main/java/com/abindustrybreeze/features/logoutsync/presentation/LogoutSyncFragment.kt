package com.abindustrybreeze.features.logoutsync.presentation
...
import com.abindustrybreeze.app.AppDatabase
import com.abindustrybreeze.app.NetworkConstant
...
import com.abindustrybreeze.app.utils.Toaster
import com.abindustrybreeze.base.BaseResponse
import com.abindustrybreeze.base.presentation.BaseActivity
import com.abindustrybreeze.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.abindustrybreeze.features.billing.api.AddBillingRepoProvider
import com.abindustrybreeze.features.billing.model.AddBillingInputParamsModel
...
import com.abindustrybreeze.features.dashboard.presentation.ReasonDialog
...
import com.abindustrybreeze.features.document.model.AddEditDocumentInputParams
import com.abindustrybreeze.features.document.model.DocumentAttachmentModel
...
import com.abindustrybreeze.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.abindustrybreeze.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.abindustrybreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.abindustrybreeze.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.abindustrybreeze.features.orderhistory.model.*
...
import com.abindustrybreeze.features.quotation.model.AddQuotInputModel
import com.abindustrybreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.abindustrybreeze.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.abindustrybreeze.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.abindustrybreeze.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.abindustrybreeze.features.timesheet.model.AddTimeSheetInputModel
import com.abindustrybreeze.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.abindustrybreeze.features.viewAllOrder.model.AddOrderInputParamsModel
import com.abindustrybreeze.features.viewAllOrder.model.AddOrderInputProductList
import com.abindustrybreeze.mappackage.SendBrod
import com.abindustrybreeze.widgets.AppCustomTextView
import com.abindustrybreeze.MonitorService
import com.abindustrybreeze.MySingleton
import com.abindustrybreeze.features.addshop.model.*
import com.abindustrybreeze.features.addshop.model.assigntopplist.AddShopUploadImg
import com.abindustrybreeze.features.addshop.presentation.ShopExtraContactReq
import com.abindustrybreeze.features.addshop.presentation.multiContactRequestData
...
import com.abindustrybreeze.features.login.model.GetConcurrentUserResponse
...
import com.abindustrybreeze.features.orderITC.SyncDeleteOpptL
import com.abindustrybreeze.features.orderITC.SyncEditOppt
import com.abindustrybreeze.features.orderITC.SyncOppt
import com.abindustrybreeze.features.orderITC.SyncOpptProductL
import com.abindustrybreeze.features.orderITC.SyncOrd
import com.abindustrybreeze.features.orderITC.SyncOrdProductL
import com.abindustrybreeze.features.performance.model.Gps_status_list
import com.abindustrybreeze.features.performance.model.UpdateGpsInputListParamsModel
import com.abindustrybreeze.features.returnsOrder.ReturnProductList
import com.abindustrybreeze.features.returnsOrder.ReturnRequest
import com.abindustrybreeze.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xabindustrybreezelogsample/log.zip").path);
